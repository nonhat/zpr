(function(zpr) {
	...
	Service.prototype.getInitialStageData = function (stageId) {
		//TODO: skąd powinien być brany size
		return { 
			stage: {
				size:{
					x: 1000,
